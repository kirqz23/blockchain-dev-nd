...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
        ...
        )
    {
        ...
        originFarmerID = fetchItem.originFarmerID;
        originFarmName = fetchItem.originFarmName;
        originFarmInformation = fetchItem.originFarmInformation;
        originFarmLatitude = fetchItem.originFarmLatitude;
        originFarmLongitude = fetchItem.originFarmLongitude;
        return (
            itemSKU,
            itemUPC,
            ownerID,
        ...
        )
    {
        ...
        itemState = uint(fetchItem.itemState);
        distributorID = fetchItem.distributorID;
